...
int main(int argc, char *argv[]) {
  ...
  setsymmetrygroup(rm, quad.type, node.type,
  ...
  setsymmetrygroup(rm, hex.type, node.type,
  ...
  std::cout << "tet "
            << rm.operator()(tet.type, node.type).nodesfromelement.lnods
            << std::endl;
  std::cout << "hex "
            << rm.operator()(hex.type, node.type).nodesfromelement.lnods
            << std::endl;
  entity hex2;
  ...
  std::cout << "rm nodelocation" << rm(tet.type, node.type).nodelocation
            << std::endl;
  std::cout << "wedge" << rm(wedge.type, node.type).nodesfromelement.lnods
            << std::endl;
  std::cout << "hex2 "
            << rm.operator()(hex.type, node.type).nodesfromelement.lnods
            << std::endl;
