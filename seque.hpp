...
template<typename V, size_t S, auto P>
auto dotproduct(seque<V, S, P> const &containerA, seque<V, S, P> const &containerB, auto init, auto sumFunc,
                auto prodFunc)
{
...
template<typename V, size_t S, auto P>
void indicesfromorder(seque<V, S, P> const &sourceContainer, seque<size_t, S, P> const &sortedIndices,
                      seque<size_t, S, P> &mappingIndices, seque<size_t, S, P> &firstSortedIndices)
{
...
template<typename V, size_t S, auto P>
seque<V, S, P> getintersection(seque<V, S, P> const &sortedcontainerA, seque<V, S, P> const &sortedcontainerB)
{
...
template<typename V, size_t S, auto P>
seque<V, S, P> getunion(seque<V, S, P> const &sortedcontainerA, seque<V, S, P> const &sortedcontainerB)
{
    seque<V, S, P> resultContainer(sortedcontainerA.size + sortedcontainerB.size);
...
template<typename V, size_t S, auto P>
seque<V, S, P> getdifference(seque<V, S, P> const &sortedcontainerA, seque<V, S, P> const &sortedcontainerB)
{
    seque<V, S, P> resultContainer(sortedcontainerA.size + sortedcontainerB.size);
...
template<typename V, size_t S, auto P>
seque<V, S, P> getsymmetricdifference(seque<V, S, P> const &sortedcontainerA, seque<V, S, P> const &sortedcontainerB)
{
    seque<V, S, P> resultContainer(sortedcontainerA.size + sortedcontainerB.size);
...
template<typename V, size_t S, auto P>
bool getincludessubset(seque<V, S, P> const &sortedsuperset, seque<V, S, P> const &sortedsubset)
{
