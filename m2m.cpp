...
void getelementstoelements(m2m const &rel, m2m &elementstoelements) {
  assert(rel.isupdated);
  hidden::multiplication(rel.nodesfromelement, rel.elementsfromnode, elementstoelements.nodesfromelement);
  elementstoelements.isupdated = false;
}

void getnodestonodes(m2m const &rel, m2m &nodestonodes) {
  assert(rel.isupdated);
  hidden::multiplication(rel.elementsfromnode, rel.nodesfromelement, nodestonodes.nodesfromelement);
