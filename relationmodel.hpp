 ...
 * within the model. It also maintains the number of entities in the model.
 */
...
/**
 * Updates the number of entities in a relation model.
 *
 ...
 */
void relationmodelsetnumberofentities(relationmodel IO rm, size_t IN nentities);

/**
 * Inserts a dependency between two types in the relation model.
 *
 ...
 */
void relationmodelinsertdependence(relationmodel IO rm, size_t IN dependenttype, size_t IN requiredtype,
                                   size_t IN howmanytimes);
 ...
 * @param rm
 */
void relationmodelclose(relationmodel IO rm);
 ...
 */
sek<size_t> relationmodelgetorder(relationmodel IN rm);
